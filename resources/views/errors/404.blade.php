    ...
    <div class="page-error">
        ...
        <div class="page-error__body">
            <div class="error-detail pb-2">
                <h4 class="font-weight-bold text-left">{{ __('custom_error.heading_404') }}</h4>
                <h5 class="font-weight-bold text-left">{{ __('custom_error.title_404') }}</h5>
                <p class="text-left mb-0">{{ __('custom_error.content_404') }}</p>
            </div>
