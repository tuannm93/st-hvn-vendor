<div class="form-table mb-4 commission-table old-commission">
    <div class="row mx-0 form-table-cell">
        <div class="col-12 row m-0 bg-primary-lighter p-0">
            ...
            {{--<div class="col-12 col-lg-3 py-3 text-right"><a class="text--orange" href="{{ route('commission.detail', ['id' => $commissionInfo->id ?? '']) }}">詳細</a></div>--}}
        </div>
    </div>
    <div class="row mx-0 form-table-cell">
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3 ">
                ...
                {!! Form::checkbox('commissionInfo['. $key .'][del_flg]', 1, isset($commissionInfo['del_flg']) ? $commissionInfo['del_flg'] == 1 : false, ['class' => 'custom-control-input', 'id' => 'del_flg'.$key]) !!}
    ...
    <div class="row mx-0 form-table-cell">
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3 ">
                ...
                {!! Form::checkbox('commissionInfo['. $key .'][first_commission]', 1, isset($commissionInfo['first_commission']) ? $commissionInfo['first_commission'] == 1 : false, ['class' => 'custom-control-input', 'id' => 'first_commission' . $key]) !!}
    ...
    <div class="row mx-0 form-table-cell">
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3 ">
                ...
                {!! Form::checkbox('commissionInfo['. $key .'][unit_price_calc_exclude]', 1, isset($commissionInfo['unit_price_calc_exclude']) ? $commissionInfo['unit_price_calc_exclude'] == 1 : false, ['class' => 'custom-control-input', 'id' => 'unit_price_calc_exclude'. $key]) !!}
        ...
        <div class="col-12 col-lg-6 row m-0 p-0">
            ...
            <div class="col-12 col-lg-6 py-2">
                <div class="form-group d-flex justify-content-around align-items-center mb-lg-0">
                    {!! Form::text('commissionInfo['. $key .'][commission_note_send_datetime]', $commissionInfo['commission_note_send_datetime_format'] ?? '', ['class' => 'form-control datetimepicker', 'id' => 'commission_note_send_datetime'.$key]) !!}
                </div>
        ...
        <div class="col-12 col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3">
                <div class="d-inline-block align-middle custom-control custom-checkbox mr-sm-2">
                    ...
                    {!! Form::checkbox('commissionInfo['. $key .'][commit_flg]', 1, isset($commissionInfo['commit_flg']) ? $commissionInfo['commit_flg'] == 1 : false,
                    ['class' => 'commission_commit_flg custom-control-input chk-commit-flg', 'data-id' => $key, 'id' => 'commit_flg'. $key]) !!}
                ...
                <div class="d-inline-block custom-control custom-checkbox demand-detail-custom-checkbox">
                    ...
                    {!! Form::checkbox('demandInfo[calendar_flg]', 1, isset(old('demandInfo')['calendar_flg']) && old('demandInfo')['calendar_flg']  == 1,
    ...
    <div class="row mx-0 form-table-cell">
            ...
            <div class="col-lg-6 py-2 d-flex align-items-center ">
                <p class="mb-0">
                    ...
                    @if($commissionInfo['send_mail_fax'] == 1)
                        送信済み　{{$commissionInfo['send_mail_fax_datetime']}}
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3 ">
                ...
                {!! Form::checkbox('commissionInfo['. $key .'][lost_flg]', 1, isset($commissionInfo['lost_flg']) ? $commissionInfo['lost_flg'] == 1 : false, ['class' => 'custom-control-input', 'id' => 'lost_flg' . $key]) !!}
    ...
    <div class="row mx-0 form-table-cell">
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center custom-control custom-checkbox p-3 ">
                ...
                {!! Form::checkbox('commissionInfo['. $key .'][corp_claim_flg]', 1, isset($commissionInfo['corp_claim_flg']) ? $commissionInfo['corp_claim_flg'] == 1 : false, ['class' => 'custom-control-input', 'id' => 'corp_claim_flg' . $key]) !!}
        ...
        <div class="col-lg-6 row m-0 p-0">
            ...
            <div class="col-lg-6 d-flex align-items-center py-2 ">
                <input class="custom-control-input" id="commissionInfo[{{ $key }}][staff_phone]"
                        ...
                        value={{ $commissionInfo['staff_phone'] ?? '' }} >
                <a href="{{checkDevice().($commissionInfo['phone_staff'] ?? '')}}" class="text--orange phone"
                    for="">{{ $commissionInfo['staff_phone'] ?? '' }}</a>
            </div>
        </div>
    </div>
    @endif
